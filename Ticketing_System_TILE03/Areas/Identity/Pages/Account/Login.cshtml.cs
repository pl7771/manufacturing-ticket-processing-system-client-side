...
namespace Ticketing_System_TILE03.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    createLoginAttempt(Input.Email, true);
                ...
                if (result.IsLockedOut)
                {
                    ...
                    createLoginAttempt(Input.Email, false);
        ...
        public void createLoginAttempt(string userName, bool succeeded)
        {
            LoginAttempt loginAttempt = new LoginAttempt(userName);
            if (succeeded)
            {
                loginAttempt.LoginSucces();
            } else
            {
